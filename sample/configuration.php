...
$configArray["gatewayUrl"] = "https://test-network.mtf.gateway.mastercard.com/api/rest";

// Merchant ID supplied by your payments provider
$configArray["merchantId"] = "TESTNITEST2";

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "merchant.TESTNITEST2";

// API password which can be configured in Merchant Administration
$configArray["password"] = "050ccb036307426a6a4ace4a57a70ad2";
